from config import (DNA, LARGURA, ALTURA, PESO_DANO, PESO_VISAO, PESO_ENERGIA, PESO_VELOCIDADE, FITNESS_MIN, FITNESS_MAX, RAIO_MIN, RAIO_MAX, FPS, PORCENTAGEM_PARA_REPRODUCAO, VAR_DANO, VAR_VISAO, VAR_VELOCIDADE, VAR_ENERGIA_MAX, TEMPO_PARA_REPRODUCAO, ESCALA)
import random
import math
import pygame
